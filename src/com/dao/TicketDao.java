...
public class TicketDao {
	 ...
	 * @throws Exception	
	 */
	public boolean BookTicket(Connection con,String username, int id,String d1_t,String d2_t,String qidian,String mudi) throws Exception{
		...
		String sql3 = "insert into t_voyage_info "
				+ "(user, ticket_id ,departure_time, arrive_time, qidian, mudi)"
				+ " values (?,?,?,?,?,?)";
